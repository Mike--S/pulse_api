...
var patientDoctors = {
  therapist: [
    {
      id: 0,
      title: 'Угрюмов Олег Петрович',
      invitation: {
        date: new Date(today.setDate(today.getDate() + 1)).toLocaleString('ru', {month: 'long', year: 'numeric', day: 'numeric'})
      }
    }
  ],
  consultants: [
    ...
    {
      id: 2,
      title: 'Глазырин Алексей Иванович'
    },
    {
      id: 3,
...
var doctorsPatient = {
  selfPatients: [
    {
      id: 1,
      title: 'Еремин Виталий Викторович'
    },
    {
      id: 2,
      title: 'Двинских Николай Петрович'
    },
    {
      id: 3,
      title: 'Синицын Олег Викторович'
    },
    {
      id: 4,
      title: 'Перевозчиков Сергей Петрович'
    },
    {
      id: 5,
      title: 'Глазырина Вера Петровна'
    }
  ],
  request: [
    {
      id: 6,
      title: 'Селина Ольга Петровна'
    }
  ],
  onConsultation: [
    {
    ...
    {
      id: 7,
      title: 'Федоринова Ирина Александровна'
    }
  ]
};
...
var diaryToday = {
  ...
  recommendations: {
    id: 1,
    doctor: 'Угрюмов Олег Петрович',
    setDate: new Date().toLocaleString('ru', {month: 'long', year: 'numeric', day: 'numeric'}),
